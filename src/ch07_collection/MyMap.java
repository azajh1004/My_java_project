...
public class MyMap {
    public static void main(String[] args) {
        ...
        // 'nc' 팀이 존재 한는 지 체크하고, 없으면 순위 5위로 추가
        ...
        if (teamMap.containsValue(pos) == true) {
            System.out.println(pos + "위 팀은 존재 합니다.");

        } else {
            System.out.println(pos + "위 팀은 존재 하지 않아서 추가합니다.");
            teamMap.put("kia", pos);
        }
        ...
        if (rank == null) {
            System.out.println(findItem + "위 팀은 존재 합니다.");
        } else {
            System.out.println(findItem + " 팀은 존재 하지 않아서 추가합니다.");
        }
