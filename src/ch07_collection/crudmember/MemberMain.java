...
public class MemberMain {
    public static void main(String[] args) {
        ...
        dao.insertDate(new Member("lee","이수진",30, "여자"));
        ...
        System.out.println("\t특정 아이디를 이용하여 특정 회원 정보를 조회(출력) 합니다.");
        String findId = "lee"; // not null
        ...
        System.out.println("회원 목로을 전부 삭제 합니다.");
        dao.deleteAllData();
